...
def gui(show,xr,yr,xl,yl,error,error1,Clutch,a,roboterror,checkerrorvar,connectionstatus,SlvCntrl,LeftLoadCell,RightLoadCell,SystemState,LeftConstWrist,RightConstWrist,LeftVirtualClutch,RightVirtualClutch,Distance,scale,timer,prevtimer,prevtimer2,VoiceCheck,PositionSound,LGraspLck,RGraspLck,ArmsAreClosToEachother,RightArmIsCloseToLens,LeftArmIsCloseToLens):
    ...
    def create_circle(x, y, r, canvasName):
        ...
        x1 = x + r
        y1 = y + r
        z=canvasName.create_oval(x0, y0, x1, y1,fill=rgb_hack((101,54,61)),outline=rgb_hack((101,54,61)),width=3)
        return z
...
#window
   ...
   # root.attributes("-fullscreen",True)
    ...
    press10 = PhotoImage(file='/home/pi/Codes/New/10 .png')
    press10=press10.subsample(4, 4)
    #press10c=canvas.create_image(w/2+22,h/2-350, anchor=NW, image=press10)
    
    press20 = PhotoImage(file='/home/pi/Codes/New/20 .png')
    press20=press20.subsample(4, 4)
    #press20c=canvas.create_image(w/2+22,h/2-350, anchor=NW, image=press20)
    
    press30 = PhotoImage(file='/home/pi/Codes/New/30 .png')
    press30=press30.subsample(4, 4)
    #press30c=canvas.create_image(w/2+22,h/2-350, anchor=NW, image=press30)
    
    press40 = PhotoImage(file='/home/pi/Codes/New/40 .png')
    press40=press40.subsample(4, 4)
    #press40c=canvas.create_image(w/2+22,h/2-350, anchor=NW, image=press40)
    
    press50 = PhotoImage(file='/home/pi/Codes/New/50 .png')
    press50=press50.subsample(4, 4)
    #press50c=canvas.create_image(w/2+22,h/2-350, anchor=NW, image=press50)
    
    press60 = PhotoImage(file='/home/pi/Codes/New/60 .png')
    press60=press60.subsample(4, 4)
    #press60c=canvas.create_image(w/2+22,h/2-350, anchor=NW, image=press60)
    
    press70 = PhotoImage(file='/home/pi/Codes/New/70 .png')
    press70=press70.subsample(4, 4)
    #press70c=canvas.create_image(w/2+22,h/2-350, anchor=NW, image=press70)
    
    press80 = PhotoImage(file='/home/pi/Codes/New/80 .png')
    press80=press80.subsample(4, 4)
    #press80c=canvas.create_image(w/2+22,h/2-350, anchor=NW, image=press80)
    
    
    press90 = PhotoImage(file='/home/pi/Codes/New/90 .png')
    press90=press90.subsample(4, 4)
    #press90c=canvas.create_image(w/2+22,h/2-350, anchor=NW, image=press90)
    
    press100 = PhotoImage(file='/home/pi/Codes/New/100 .png')
    press100=press100.subsample(4, 4)
    #press100c=canvas.create_image(w/2+22,h/2-350, anchor=NW, image=press100)
    ...
    #redpress100c=canvas.create_image(w/2+22,h/2-350, anchor=NW, image=redpress100)
    LeftPressurecircle=canvas.create_image(w/2-250,h/2-380, anchor=NW, image=press100)
    RightPressurecircle=canvas.create_image(w/2+15,h/2-380, anchor=NW, image=press100)
...
#create circle.................................................................
    ...
    arc1=create_circle_arc(canvas,w/2-132, round(0.28*h), 90, style="arc", outline=rgb_hack((80, 170, 127)), width=20,
                               start=90, end=90)
    #,state='hidden')
    leftpressure=canvas.create_text(w/2-132,round(0.28*h)+13,fill="white",font=("Times New Roman", 16, "bold"),text=" ")
    rightpressure=canvas.create_text(w/2+132,round(0.28*h)+13,fill="white",font=("Times New Roman", 16, "bold"),text=" ")
...
#                     print('system state is in error')
                    ...
                    canvas.itemconfig(LeftPressurecircle,state='hidden')
                    canvas.itemconfig(RightPressurecircle,state='hidden')
...
#                         print("line1367")
                        ...
                        canvas.itemconfig(img3c,state='hidden')
                        canvas.itemconfig(c3l,state='hidden')
                        canvas.itemconfig(LeftPressurecircle,state='normal')
#                         print("line1372")
                        if LeftLoadCell.value<0.11:
                            canvas.itemconfig(LeftPressurecircle,image=press10) 
                        elif LeftLoadCell.value<0.21:
                            canvas.itemconfig(LeftPressurecircle,image=press20) 
                        elif LeftLoadCell.value<0.31:
                            canvas.itemconfig(LeftPressurecircle,image=press30) 
                        elif LeftLoadCell.value<0.41:
                            canvas.itemconfig(LeftPressurecircle,image=press40) 
                        elif LeftLoadCell.value<0.51:
                            canvas.itemconfig(LeftPressurecircle,image=press50) 
                        elif LeftLoadCell.value<0.61:
                            canvas.itemconfig(LeftPressurecircle,image=press60) 
                        elif LeftLoadCell.value<0.71:
                            canvas.itemconfig(LeftPressurecircle,image=press70) 
                        elif LeftLoadCell.value<0.81:
                            canvas.itemconfig(LeftPressurecircle,image=press80) 
                        elif LeftLoadCell.value<0.91:
                            canvas.itemconfig(LeftPressurecircle,image=press90) 
                        elif LeftLoadCell.value<1.1:
                            canvas.itemconfig(LeftPressurecircle,image=press100) 
                        elif LeftLoadCell.value==0:
                            canvas.itemconfig(LeftPressurecircle,image=press10)
#                         print("line1392")
...
#                     print("line1409")
                    if RightVirtualClutch.value==1:
                        ...
                        canvas.itemconfig(img2c,state='hidden')
                        canvas.itemconfig(c4r,state='hidden')
                        canvas.itemconfig(RightPressurecircle,state='normal')
                        if RightLoadCell.value<0.11:
                            canvas.itemconfig(RightPressurecircle,image=press10) 
                        elif RightLoadCell.value<0.21:
                            canvas.itemconfig(RightPressurecircle,image=press20) 
                        elif RightLoadCell.value<0.31:
                            canvas.itemconfig(RightPressurecircle,image=press30) 
                        elif RightLoadCell.value<0.41:
                            canvas.itemconfig(RightPressurecircle,image=press40) 
                        elif RightLoadCell.value<0.51:
                            canvas.itemconfig(RightPressurecircle,image=press50) 
                        elif RightLoadCell.value<0.61:
                            canvas.itemconfig(RightPressurecircle,image=press60) 
                        elif RightLoadCell.value<0.71:
                            canvas.itemconfig(RightPressurecircle,image=press70) 
                        elif RightLoadCell.value<0.81:
                            canvas.itemconfig(RightPressurecircle,image=press80) 
                        elif RightLoadCell.value<0.91:
                            canvas.itemconfig(RightPressurecircle,image=press90) 
                        elif RightLoadCell.value<1.1:
                            canvas.itemconfig(RightPressurecircle,image=press100) 
                        elif RightLoadCell.value==0:
                            canvas.itemconfig(RightPressurecircle,image=press10)
